/* ============================================================
   config.js — Configuración estática central
   ============================================================ */

const CFG = {
  user: 'Oscaromar',  // Se sobreescribe desde settings al cargar

  /* true = versión pública (GitHub Pages, sin datos personales)
     false = versión personal (VPS, panel hijo + salud + Nexus) */
  publicMode: true,
  ...
  /* ---- Ciudades (Open-Meteo) ---- */
  cities: {
    lapaz:          { name: 'La Paz',          state: 'BCS',   role: '🏠 Tu base',   lat: 24.1426,  lon: -110.3128, tz: 'America%2FMazatlan' },
    acayucan:       { name: 'Acayucan',         state: 'Ver.',  role: '👨‍👩‍👦 Padres',   lat: 17.9494,  lon: -94.9143,  tz: 'America%2FMexico_City' },
    puertoescondido:{ name: 'Pto. Escondido',   state: 'Oax.',  role: '💖 Tu hijo',   lat: 15.8624,  lon: -97.0730,  tz: 'America%2FMexico_City' },
    tulum:          { name: 'Tulum',            state: 'Q.Roo', role: '🤙 Hermano',   lat: 20.2114,  lon: -87.4654,  tz: 'America%2FCancun' }
  },

  /* ---- Ventana de contacto con el hijo (UTC-6) ---- */
  hijoWindowStart: 6,
  hijoWindowEnd:  20,
  ...
  /* ---- Versículos por día de semana (0=Dom…6=Sáb) ---- */
  versos: [
    { ref: 'Salmos 23:1',      key: 'psalm+23:1' },
    { ref: 'Jeremías 29:11',   key: 'jeremiah+29:11' },
    { ref: 'Filipenses 4:13',  key: 'philippians+4:13' },
    { ref: 'Isaías 41:10',     key: 'isaiah+41:10' },
    { ref: 'Proverbios 3:5-6', key: 'proverbs+3:5-6' },
    { ref: 'Josué 1:9',        key: 'joshua+1:9' },
    { ref: 'Romanos 8:28',     key: 'romans+8:28' }
  ],
  ...
  tracy: [
    ...
    { title: '📊 Método ABCDE',              tip: 'Clasifica cada tarea: A=crítica, B=importante, C=agradable, D=delega, E=elimina. Solo ataca las A antes del mediodía.' },
  ...
  /* ---- Proyectos (id requerido para settings) ---- */
  projects: [
    {
      id: 'pardesantos', emoji: '🟦', name: 'Par de Santos', url: 'pardesantos.mx',
      ...
      keywords: ['bienes raíces La Paz', 'casas en venta BCS', 'terrenos Los Cabos', 'inversión inmobiliaria México'],
      ideas: ['Blog: "5 razones para invertir en BCS en 2026"', 'Reel: tour virtual de propiedad', 'Keyword: "casas frente al mar La Paz"']
    },
    {
      id: 'bnrecords', emoji: '🟥', name: 'BN Records', url: 'bnrecords.mx',
      ...
      keywords: ['música independiente México', 'distribución musical digital', 'sello discográfico BCS', 'artistas emergentes'],
    ...
    {
      id: 'stratex', emoji: '🟩', name: '9Stratex', url: '9stratex.com',
      ...
      keywords: ['automatización empresas México', 'estrategia digital', 'IA para negocios', 'n8n automatización'],
    ...
    {
      id: 'paypaps', emoji: '🟨', name: 'Paypaps', url: 'paypaps.com',
      ...
      keywords: ['pagos digitales México', 'fintech PYME', 'cobros online', 'billetera digital'],
      ideas: ['Blog: "Cobra en línea sin comisiones exageradas"', 'Post: comparativa de pasarelas', 'Keyword: "cómo aceptar pagos online México"']
    }
  ],

  /* ---- Rutas en moto (Italika FT150 TS 2024) ---- */
  motoRoutes: [
    { name: 'Malecón de La Paz', dist: '8 km ida', duration: '20 min', fuel: '0.3 L', cost: '$6 MXN', diff: '⭐ Fácil',
      maps: 'https://maps.app.goo.gl/XvnLhBqBtR6p9VKFA',
      cultura: 'Paseo icónico frente a la bahía. Perfecto al amanecer o atardecer.',
      immo: 'Zona de alta plusvalía. Propiedades frente al mar cotizan 3–5x más.', minWindOk: 35 },
    { name: 'La Ventana / El Sargento', dist: '70 km', duration: '1h 20min', fuel: '2.4 L', cost: '$52 MXN', diff: '⭐⭐ Moderada',
      maps: 'https://maps.app.goo.gl/D9Vo2pNWYGWXxKEJA',
      cultura: 'Meca del kitesurf mundial. Playa increíble, comunidad extranjera.',
      immo: 'Hotspot inmobiliario. Terrenos frente al mar aún accesibles vs. Cabo.', minWindOk: 25 },
    { name: 'Todos Santos', dist: '80 km', duration: '1h 30min', fuel: '2.7 L', cost: '$58 MXN', diff: '⭐⭐ Moderada',
      maps: 'https://maps.app.goo.gl/gjnS4V4P1E3Kt7H47',
      cultura: 'Pueblo Mágico. Arte, gastronomía gourmet, arquitectura colonial.',
      immo: 'Muy cotizado por extranjeros. Casas históricas y desarrollo de lujo.', minWindOk: 30 },
    { name: 'El Triunfo', dist: '56 km', duration: '1h', fuel: '1.9 L', cost: '$41 MXN', diff: '⭐⭐ Moderada',
      maps: 'https://maps.app.goo.gl/MdNKoLPT1d6V2g7Y8',
      cultura: 'Pueblo minero del s. XIX. Chimeneas históricas, museo y café de altura.',
      immo: 'Potencial de ecoturismo. Propiedades históricas a precios bajos.', minWindOk: 30 },
    { name: 'Los Planes', dist: '65 km', duration: '1h 15min', fuel: '2.2 L', cost: '$47 MXN', diff: '⭐⭐ Moderada',
      maps: 'https://maps.app.goo.gl/nAY8pXgKqJjLP2Sj9',
      cultura: 'Valle agrícola tranquilo. Mango, dátil, caña de azúcar.',
      immo: 'Terrenos agrícolas disponibles. Potencial agroturístico.', minWindOk: 35 }
  ],
  ...
  music: [
    ...
    { icon: '🎹', label: 'Instrumental',         name: 'Lofi Hip Hop Radio — beats',      link: 'https://www.youtube.com/watch?v=jfKfPfyJRdk' },
    { icon: '🎸', label: 'Canción del día',      name: '"Oceans" — Hillsong United',      link: 'https://open.spotify.com/track/7LfDiWjMPbY0LIJapgtQSX' }
  ],

  /* ---- Checklist base (se combinan con hábitos de settings) ---- */
  baseChecklist: [
    ...
    { id: 'shutdown',  text: '🌙 Shutdown ritual',          tag: 'Cierre' },
    { id: 'gratitud',  text: '🙏 3 cosas de gratitud',      tag: 'Espíritu' }
  ],

  /* ---- Secciones (para el panel de secciones) ---- */
  sections: [
    { id: 'clima',     label: '🌤️ Clima Profesional' },
    { id: 'salud',     label: '💊 Salud & Bitácora' },
    { id: 'hijo',      label: '💖 Mensaje para mi Hijo' },
    { id: 'espiritual',label: '📖 Espiritualidad' },
    { id: 'musica',    label: '🔊 Música & Podcasts' },
    { id: 'noticias',  label: '📰 Noticias Globales' },
    { id: 'cripto',    label: '₿ Precios Cripto' },
    { id: 'prod',      label: '🧠 Productividad' },
    { id: 'proyectos', label: '🌐 Proyectos & Negocios' },
    { id: 'pesca',     label: '🐟 Índice de Pesca' },
    { id: 'moto',      label: '🏍️ Ruta en Moto' },
    { id: 'plan',      label: '🧭 Plan del Día' },
